...
### 3. 感谢tsl0922和DYC的项目，我只是一个小卡拉米，结合图片推送功能，制作了待办事项推送功能，目前已实现利用网页缓存保持之前编辑过的代办事项，能根据待办事项重要程度进行提醒，和一些小装饰。
...
- 地址：(https://kiocol.github.io/EPD-nRF5_Kiocol/html/index.html)
- 如有任何问题或者有好的创意可联系我，970848997@qq.com
